...
## Metadata
- Author: [[Paolo Galeone]]
- Full Title: Using AI for Coding: My Journey With Cline and Large Language Models
- URL: https://pgaleone.eu/ai/coding/2025/01/26/using-ai-for-coding-my-experience/

## Highlights
- To accelerate development and improve the overall user experience, I experimented with [Cline](https://github.com/cline/cline) through its VSCode plugin as my primary AI coding assistant. Here’s a detailed breakdown of my experience. ([View Highlight](https://read.readwise.io/read/01jk0n25vtcsw4ygpvggd1q6cy))
- As someone who primarily focuses on backend development, UI/UX has always been a challenge. My limited knowledge of modern web frameworks and general aversion to CSS made frontend work particularly daunting. However, leveraging AI tools transformed this weakness into an opportunity for rapid improvement. ([View Highlight](https://read.readwise.io/read/01jk0n29mv48sexpf8ky25fgt7))
- The impact was immediate and substantial. I tasked the LLMs with redesigning every page of the website:
  ...
  • The overall design evolved from basic to professional-grade ([View Highlight](https://read.readwise.io/read/01jk0n2h2cev265eprswxjh7ez))
- Working with Cline proved intuitive thanks to its ability to analyze open files and understand repository context. ([View Highlight](https://read.readwise.io/read/01jk1h18drzkt2wdsz6az9hcd0))
- • **Established Context:** Clearly identified the technology stack and file structure
  ...
  • **Specified Requirements:** Detailed the exact structure needed for the wizard implementation ([View Highlight](https://read.readwise.io/read/01jk1h29kfc16a0rc7spe7ejam))
- • **Expertise Matters:**
  ...
  • Code review skills remained essential for quality assurance ([View Highlight](https://read.readwise.io/read/01jk1h46zhw7v7pq5epzsvfjzm))
- In particular, I asked ChatGPT to write a function by knowing **precisely** how I would have implemented it. This is crucial since without knowing the expected result and what every line does, I might end up with a wrong implementation. The function I asked to implement is a simple similarity score among strings. Since the bot is posting deals by searching for keywords on Amazon, the PA-API is likely to return on the same request multiple version of the same product (e.g. a blue camera vs a black camera of the very same model). ([View Highlight](https://read.readwise.io/read/01jk1h4p90mtqjap9myhmep1b7))
- With a very precise prompt, that must contain also a valid example, the generated function is very similar to the one I had in mind to solve this problem. ([View Highlight](https://read.readwise.io/read/01jk1h4x97r858k6c6qfvjtyye))
- The generation time is just a couple of seconds, plus one minute to read and understand if the function does what I requested. The boost in productivity is huge since I would have spent at least 3 or 4 times this time to write by myself the function. ([View Highlight](https://read.readwise.io/read/01jk1h5h52rexyfsx099eggj5j))

...
tags:
  ...
  - literature-note
---
![rw-book-cover](https://readwise-assets.s3.amazonaws.com/media/uploaded_book_covers/profile_691412/RNaqOr_l4nrOANE1AOmMyJIaPrzbXMo46s6hs1GuYbc-cover_jaKOzi6.png)

## Metadata
- Author: [[readwise.io]]
- Full Title: GENERATIVE AI AT WORK
- Document Note: The study examines the impact of generative AI on the productivity of customer service agents in the context of a customer support center. The AI assistant was found to increase worker productivity by 14%, leading to a decline in time taken to handle chats and an increase in the number of chats resolved per hour. The AI tool also helped newer agents move more quickly down the experience curve. Additionally, the introduction of AI systems had a marked impact on customer sentiment towards agents, resulting in a decline in customer requests to speak to a manager.

...
tags:
  ...
  - literature-note
---
![rw-book-cover](https://hamel.dev/blog/posts/field-guide/images/field_guide.png)

## Metadata
- Author: [[Hamel Husain]]
- Full Title: A Field Guide to Rapidly Improving AI Products
- URL: https://hamel.dev/blog/posts/field-guide/

## Highlights
- A Field Guide to Rapidly Improving AI Products
  [LLMs](https://hamel.dev/index.html#category=LLMs)
  [AI](https://hamel.dev/index.html#category=AI)
  ...
  1. The Most Common Mistake: Skipping Error Analysis[](https://hamel.dev/blog/posts/field-guide/#the-most-common-mistake-skipping-error-analysis)
  ...
  The Error Analysis Process[](https://hamel.dev/blog/posts/field-guide/#the-error-analysis-process)
  ...
  Bottom-Up vs. Top-Down Analysis[](https://hamel.dev/blog/posts/field-guide/#bottom-up-vs.-top-down-analysis)
  ...
  If you’d like to see error analysis in action, we recorded a [live walkthrough here](https://youtu.be/qH1dZ8JLLdU). ([View Highlight](https://read.readwise.io/read/01kzdvk7ptqa8n4q89nem7gme9))
- 2. The Most Important AI Investment: A Simple Data Viewer[](https://hamel.dev/blog/posts/field-guide/#the-most-important-ai-investment-a-simple-data-viewer)
  ...
  This brings us to another counter-intuitive lesson: the people best positioned to improve your AI system are often the ones who know the least about AI. ([View Highlight](https://read.readwise.io/read/01kzdvnvsee3p8q996ke0xhm4c))
- 3. Empower Domain Experts To Write Prompts[](https://hamel.dev/blog/posts/field-guide/#empower-domain-experts-to-write-prompts)
  ...
  Build Bridges, Not Gatekeepers[](https://hamel.dev/blog/posts/field-guide/#build-bridges-not-gatekeepers)
  ...
  ![](https://hamel.dev/blog/posts/field-guide/images/ipe_after.png) ([View Highlight](https://read.readwise.io/read/01kzdvpj3skk6gs5amtrft7409))
- Tips For Communicating With Domain Experts[](https://hamel.dev/blog/posts/field-guide/#tips-for-communicating-with-domain-experts)
  ...
  The challenge many teams raise at this point is: “This all sounds great, but what if we don’t have any data yet? How can we look at examples or iterate on prompts when we’re just starting out?” That’s what we’ll talk about next. ([View Highlight](https://read.readwise.io/read/01kzdvpy05gqw3gjfd5yq4bkvb))
- 4. Bootstrapping Your AI With Synthetic Data Is Effective (Even With Zero Users)[](https://hamel.dev/blog/posts/field-guide/#bootstrapping-your-ai-with-synthetic-data-is-effective-even-with-zero-users)
  ...
  > “LLMs are surprisingly good at generating excellent - and diverse - examples of user prompts. This can be relevant for powering application features, and sneakily, for building Evals. If this sounds a bit like the Large Language Snake is eating its tail, I was just as surprised as you! All I can say is: it works, ship it.” ([View Highlight](https://read.readwise.io/read/01kzdwx37aewvegsy2w0pm8bpw))
- A Framework for Generating Realistic Test Data[](https://hamel.dev/blog/posts/field-guide/#a-framework-for-generating-realistic-test-data)
  ...
  These aren’t the only dimensions you might care about – you might also want to test different tones of voice, levels of technical sophistication, or even different locales and languages. The important thing is identifying dimensions that matter for your specific use case. ([View Highlight](https://read.readwise.io/read/01kzdwx70qtgcfp6r7ecxxdpgf))
- For a real estate CRM AI assistant I worked on with [Rechat](https://www.rechat.com/), we defined these dimensions like this:
  ...
  no matches
  investor
  “Need comps for 123 Oak St. Specifically interested in rental yield comparison with similar properties in a 2-mile radius.” ([View Highlight](https://read.readwise.io/read/01kzdwxwv1t1xf4g19a6fcmzxb))
- he key to useful synthetic data is grounding it in real system constraints. For the real-estate AI assistant, this means:
...
- uidelines for Using Synthetic Data[](https://hamel.dev/blog/posts/field-guide/#guidelines-for-using-synthetic-data)
  ...
  This approach isn’t just theoretical – it’s been proven in production across dozens of companies. What often starts as a stopgap measure becomes a permanent part of the evaluation infrastructure, even after real user data becomes available. ([View Highlight](https://read.readwise.io/read/01kzdwyf5eqdbgyp0ry7ks2an4))
- 5. Maintaining Trust In Evals Is Critical[](https://hamel.dev/blog/posts/field-guide/#maintaining-trust-in-evals-is-critical)
  ...
  Maintaining trust in your evaluation system is just as important as building it in the first place. Here’s how the most successful teams approach this challenge: ([View Highlight](https://read.readwise.io/read/01kzdwyrkwg4e66cycbf595tf3))
- Understanding Criteria Drift[](https://hamel.dev/blog/posts/field-guide/#understanding-criteria-drift)
...
- Creating Trustworthy Evaluation Systems[](https://hamel.dev/blog/posts/field-guide/#creating-trustworthy-evaluation-systems)
  ...
  1. Favor Binary Decisions Over Arbitrary Scales[](https://hamel.dev/blog/posts/field-guide/#favor-binary-decisions-over-arbitrary-scales)
...
- Scaling Without Losing Trust[](https://hamel.dev/blog/posts/field-guide/#scaling-without-losing-trust)
  ...
  Now that we’ve covered how to maintain trust in your evaluations, let’s talk about a fundamental shift in how you should approach AI development roadmaps… ([View Highlight](https://read.readwise.io/read/01kzdx0ccmswdg57gh9q3932je))
- 6. Your AI Roadmap Should Count Experiments, Not Features[](https://hamel.dev/blog/posts/field-guide/#your-ai-roadmap-should-count-experiments-not-features)
...
- The Foundation: Evaluation Infrastructure[](https://hamel.dev/blog/posts/field-guide/#the-foundation-evaluation-infrastructure)
  ...
  This wasn’t wasted time—it was the foundation that accelerated everything. With solid evaluation in place, the team ran thousands of experiments, quickly identified what worked, and could say with confidence “this change improved quality by X%” instead of relying on gut feelings. While the upfront investment in evaluation feels slow, it prevents endless debates about whether changes help or hurt, and dramatically speeds up innovation later. ([View Highlight](https://read.readwise.io/read/01kzdx3bq1dwt52z2n7b5ebzxd))
- Communicating This to Stakeholders[](https://hamel.dev/blog/posts/field-guide/#communicating-this-to-stakeholders)
...
- A Better Way Forward[](https://hamel.dev/blog/posts/field-guide/#a-better-way-forward)
  ...
  By reframing your roadmap around experiments rather than features, you create the conditions for similar breakthroughs in your own organization. ([View Highlight](https://read.readwise.io/read/01kzdx52zatseyxh4cgb86sq9h))
- Conclusion[](https://hamel.dev/blog/posts/field-guide/#conclusion)
  ...
  These principles apply regardless of your domain, team size, or technical stack. They’ve worked for companies ranging from early-stage startups to tech giants, across use cases from customer support to code generation. ([View Highlight](https://read.readwise.io/read/01kzdx57b6es6nmksdmatxqs46))

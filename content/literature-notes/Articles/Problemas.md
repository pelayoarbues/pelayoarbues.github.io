...
## Metadata
- Author: [[cesargarcia.com]]
- Full Title: Problemas
- URL: https://cesargarcia.com/inquiettudes/2025/02/12/problemas/

## Highlights
- Vivimos tiempos en los que la velocidad lo define todo: desde consumir información hasta tomar decisiones. Cuanto más rápido nos movemos, más creemos que progresamos. Con la AI podemos hacer que la ejecución sea más rápida que nunca, y es fantástico aprovechar su potencial. Pero la velocidad sin un objetivo es solo movimiento, no progreso. ([View Highlight](https://read.readwise.io/read/01jm80spsv3r7v4vgbhf9jejg2))
- El reto no está en hacer las cosas rápido, sino en asegurar que estamos resolviendo el problema adecuado. Y, después, si es rápido, mejor. ([View Highlight](https://read.readwise.io/read/01jm80sw47cc6knv2f4mb4a16m))
- Qué puede hacer la AI muy bien
  ...
  • Las mejores soluciones casi siempre empiezan por definir muy bien el problema. ([View Highlight](https://read.readwise.io/read/01jm80t8z9jb7gk51qfv74qqrs))
- En «El cuervo sediento» o «El cuervo y la jarra», de Esopo, un cuervo se enfrenta al reto de beber agua sin la ayuda de la AI pero con mucho ingenio y mucha calma.
  ...
  > 
  > Fábulas de Esopo ([View Highlight](https://read.readwise.io/read/01jm80tz4ppncc5mvdcd5rt46t))
- Nosotros, en el mundo de la IA, los negocios y la tecnología, muchas veces caemos en la misma trampa: nos enfocamos en la ejecución antes de entender el problema.
  ...
  • No te quedes con la primera respuesta. Muchas veces, la mejor solución surge cuando replanteamos el problema desde otro ángulo. ([View Highlight](https://read.readwise.io/read/01jm80vhwfwq6a371b0dp6thm4))

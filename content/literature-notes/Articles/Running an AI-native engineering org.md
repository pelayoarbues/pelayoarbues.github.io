...
tags:
  ...
  - literature-note
---
![rw-book-cover](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/6a1f0f1a5a045e955123064a_og_running-an-ai-native-engineering-org.jpg)

## Metadata
- Author: [[claude.com]]
- Full Title: Running an AI-native engineering org
- URL: https://claude.com/blog/running-an-ai-native-engineering-org?utm_source=tldrai

## Highlights
- For years, engineering bandwidth was the expensive part of building applications. Every process we used to have around software planning and shipping, first waterfall and then agile, was built around that cost. ([View Highlight](https://read.readwise.io/read/01kthjwrj4y7n4d7x6nbvvd6bc))
- On the Claude Code team, writing code, writing tests, and refactoring rarely slows us down anymore. But the bottlenecks didn’t go away when agentic coding took away the actual need to type code. Verification, code review, and security took their place. ([View Highlight](https://read.readwise.io/read/01kthjxbnp1t6thyzgywmwyjds))
- We can all generate a lot of code really fast now, but this also brings up new questions: Is this code correct? How is it maintained? And one of the top questions I get from fellow engineering leaders: “How are humans keeping up with how you’re doing code reviews?” ([View Highlight](https://read.readwise.io/read/01kthjxg88s77xf3ram869z94h))
- We all put processes in place for a reason, to close a gap or make something work better. But when that gap no longer exists and those processes become obsolete, they rarely go away on their own. When the Claude Code team began using agentic coding as our default way of working, a lot of our existing processes stopped working. Here are the norms we rewrote, and why. ([View Highlight](https://read.readwise.io/read/01kthjy0zptk9h5kbwtcfaya82))
...
- Code review: trust but verify
  ...
  It’s important to continually evaluate, though, because the right balance of trust vs. verify will keep changing as the models improve. What you need humans for today might look different with the next model. ([View Highlight](https://read.readwise.io/read/01kthky6jdxpfv5my58x86k2tq))
...
- What I index on less, on the other hand, is raw throughput; the models handle that. The more important question is where you still need human expertise, and that’s where I’d focus.
  ...
  Roles blur: PMs prototype, engineers take on design and context. Hire for creative builders and deep systems expertise. ([View Highlight](https://read.readwise.io/read/01kthm06y144j3b3261ypgk64h))
- How we rolled out our new norms
  ...
  Within these few rules, though, each pod has a lot of agency. They have room to adapt how they use Claude to do triage, how they run any planning rituals or standups, and which workflows get “Claudified” first. ([View Highlight](https://read.readwise.io/read/01kthm181y97fmewcgmnsa38wv))
- How to know your new processes are sticking
  ...
  On the third bullet, don't confuse throughput with success. Throughput is one metric, but the real metric is measuring the thing you're trying to solve. With the right alignment, throughput can help you solve problems faster. ([View Highlight](https://read.readwise.io/read/01kthm2rwhw5a1dkrn336hevmb))
